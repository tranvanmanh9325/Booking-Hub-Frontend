...
const PartnerLayout: React.FC<PartnerLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    // Users menu item removed for Partner
    {
      title: t('content'),
    ...
    <div className="admin-layout">
      <aside className="sidebar">
        <div className="logo-container">
          <Link href="/partner/dashboard" className="logo-link">
          ...
          <div className="header-right">
            ...
            <div className="user-profile">
              <div className="user-avatar" style={user?.avatarUrl ? {
                ...
                {(!user?.avatarUrl) && (user?.fullName?.[0] || 'P')}
              </div>
              <div className="user-info">
                <span className="user-name">{user?.fullName || 'Partner User'}</span>
                <span className="user-role">{user?.role || 'Partner'}</span>
              </div>
            </div>
          </div>
        </header>
