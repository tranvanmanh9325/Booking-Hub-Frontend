...
const Attractions: React.FC = () => {
  useEffect(() => {
    ...
    const track = document.querySelector('.carousel-container') as HTMLElement | null
    if (track) {
      let isDown = false
      let startX: number
      ...
      const handleMouseDown = (e: Event) => {
        ...
        isDown = true
        startX = mouseEvent.pageX - track.offsetLeft
      ...
      const handleMouseMove = (e: Event) => {
        ...
        const x = mouseEvent.pageX - track.offsetLeft
