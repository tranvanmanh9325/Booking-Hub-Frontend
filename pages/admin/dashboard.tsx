    ...
    <AdminLayout>
      ...
      <div className="dashboard-container">
        <div className="welcome-banner">
          <h1>Chào mừng trở lại, {user?.fullName || 'Partner'}!</h1>
          <p>Đây là tổng quan về hoạt động kinh doanh của bạn hôm nay.</p>
        </div>

        <div className="stats-grid">
          <Card className="stat-card">
            <div className="stat-header">
              <span className="stat-title">Doanh thu hôm nay</span>
          ...
          <Card className="stat-card">
            <div className="stat-header">
              <span className="stat-title">Đơn đặt mới</span>
          ...
          <Card className="stat-card">
            <div className="stat-header">
              <span className="stat-title">Đánh giá 5 sao</span>
            ...
            <div className="stat-trend neutral">
              <span>Tổng cộng trên hệ thống</span>
            </div>
          </Card>
        </div>
            ...
            <ul className="activity-list">
              <li className="activity-item">
                ...
                <div className="activity-content">
                  <span className="activity-text">Đơn đặt phòng mới từ <strong>Nguyễn Văn A</strong></span>
              ...
              <li className="activity-item">
                ...
                <div className="activity-content">
                  <span className="activity-text">Thanh toán thành công đơn hàng <strong>#12345</strong></span>
              ...
              <li className="activity-item">
                ...
                <div className="activity-content">
                  <span className="activity-text">Tin nhắn mới từ đối tác <strong>CGV Cinemas</strong></span>
