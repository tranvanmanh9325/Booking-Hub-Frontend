  ...
  return (
    <>
      <NextSeo
        ...
        description="Đặt bàn nhà hàng trực tuyến, kiểm tra chỗ trống và xem menu tại Booking Hub."
        canonical="https://bookinghub.com/booking/restaurant-reservations"
        openGraph={{
          url: 'https://bookinghub.com/booking/restaurant-reservations',
          title: 'Đặt Bàn Nhà Hàng - Booking Hub',
          description: 'Hệ thống đặt bàn nhà hàng thông minh, tiện lợi.',
          images: [
            {
              url: 'https://images.pexels.com/photos/2291599/pexels-photo-2291599.jpeg',
              width: 800,
              height: 600,
              alt: 'Restaurant Hero',
            },
